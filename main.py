...
def save_invoice():
    ...
    if invoice_id:
        ...
        # שלב ב': עדכון נתוני כותרת החשבונית (Fixed to use db_customer_id)
        ...
        # שלב ה': עדכון או יצירת תנועה פיננסית ביומן התנועות (Transaction) - Fixed to use db_customer_id
    ...
    # ====== 2. יצירת חשבונית חדשה לחלוטין (מצב יצירה) ======
        ...
        import traceback
        traceback.print_exc()
        flash(f"שגיאה חמורה בשמירת נתוני החחשבונית: {str(e)}", "danger")
        return redirect(url_for('invoice'))
