...
def invoice():
    ...
    customer_id = request.args.get('customer_id', '0').strip() # Default to self-billing '0' if raw creation string
    ...
    #  THE CRITICAL BRIDGE: If editing/viewing, use invoice_context. If creating new, use base_invoice_context!
    if invoice_id:
