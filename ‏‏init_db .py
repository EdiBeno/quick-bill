...
def init_database():
    ...
    from database import (
        User, PasswordResetToken, Company, Customer, Employee, ShiftState, Timesheet, TimeEntry, Task, 
        Payment, PaymentLink, Invoice, InvoiceItem, Product, Category, Supplier, SupplierPurchase, Transaction, OwnerUser 
    )
