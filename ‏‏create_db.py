...
def create_database():
    ...
    from database import (
        PasswordResetToken, Company, Customer, Employee, Payment, PaymentLink, Invoice, 
        InvoiceItem, Product, Category, Supplier, SupplierPurchase, Transaction, User, OwnerUser, ShiftState, Timesheet, TimeEntry, Task
    )
