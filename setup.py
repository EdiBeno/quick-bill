...
def create_requirements():
    packages = [
        "flask", "flask-sqlalchemy", "sqlalchemy", "psycopg2-binary", 
        "flask-migrate", "celery==5.4.0", "redis==5.0.4","flask-script",
        "openpyxl", "playwright", "werkzeug", "Flask-Mail", "deep-translator", "gunicorn",
        "python-dotenv", "XlsxWriter", "flask-login", "Babel", "Flask-Babel", "flask-jwt-extended", "email-validator"
    ]
...
def install_packages():
    ...
    run_command("new_venv\\Scripts\\activate && pip install -r requirements.txt && playwright install chromium --with-deps", "Installing packages & Playwright Browser")
...
if __name__ == '__main__':
    ...
    project_path = r"C:\\Users\\AA\\Desktop\\QuickBill\\InvoiceQB"
    os.chdir(project_path)
